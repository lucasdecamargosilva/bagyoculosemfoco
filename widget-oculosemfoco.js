(function () {
    ...
    // ===============================================
    const apiKey = "pl_live_59fc0bc404bfba49aba39cf0644847f4ab55badf425d04d073fd99e48e7f6dfb";
    ...
    const html = `
        <div id="q-modal-ia">
            <div class="q-card-ia">
                ...
                <div class="q-content-scroll">
                    ...
                    <div id="q-loading-box">
                        <div class="q-loading-texts">
                            ...
                            <a href="https://provoulevou.com.br/?utm_source=widget&utm_medium=parceiro&utm_campaign=oculosemfoco" target="_blank" rel="dofollow noopener" class="q-loading-t2">
                ...
                <a href="https://provoulevou.com.br/?utm_source=widget&utm_medium=parceiro&utm_campaign=oculosemfoco" target="_blank" rel="dofollow noopener" class="q-powered-footer">
                    <span>Powered by</span>
            ...
            try {
                ...
                if (pending) {
                    ...
                    const resp = await fetch(WEBHOOK_PIX, {
                        ...
                        body: JSON.stringify({ email: 'cliente@provoulevou.com.br', phone: '55' + phoneInput.value.replace(/\D/g, ''), loja: 'oculosemfoco', origin: location.origin })
...
const fd = new FormData();
                ...
                console.log('[PL Óculos em Foco] Enviando', allProdImgs.length, 'fotos do produto');
